...
})({"lNOKz":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "078326a67c2268dd";
"use strict";
...
},{}],"hx8E4":[function(require,module,exports) {
...
window.scrollAnimation = new function() {
    ...
    this.init = function() {
        ...
        window.globalScroll.smooth.on("scroll", (0, _scrollTrigger.ScrollTrigger).update);
        (0, _gsap.gsap).ticker.add((time)=>{
    ...
    this.initView = function() {
        this.resetTrigger();
        let mm = (0, _gsap.gsap).matchMedia();
        if ($('[data-barba-namespace="homeIndex"]').length || $('[data-barba-namespace="thematiquesDetails"]').length) {
            (0, _gsap.gsap).utils.toArray("[data-barba-namespace]:last-of-type [data-title-section],footer").forEach((section, i)=>{
                this.trigger.push((0, _scrollTrigger.ScrollTrigger).create({
                    trigger: section,
                    start: "top center",
                    end: "bottom center",
            ...
            mm.add("(min-width: 768px)", ()=>{
                ...
                (0, _gsap.gsap).set("[data-barba-namespace='homeIndex'] .container", {
                    zIndex: (i, target, targets)=>targets.length - i
                });
                (0, _gsap.gsap).utils.toArray("[data-barba-namespace]:last-of-type .container .sticky-section").forEach((section, i)=>{
                    let sections = document.querySelectorAll("[data-barba-namespace]:last-of-type .container .sticky-section");
                    let animation = (0, _gsap.gsap).timeline({
                        paused: true,
                        onComplete: ()=>{
            ...
            //this.scrollSection();
            (0, _gsap.gsap).utils.toArray("[data-loop-section]").forEach((section, i)=>{
                this.trigger.push((0, _scrollTrigger.ScrollTrigger).create({
                    trigger: section,
                    start: "center bottom",
            ...
            let drawingLines = (0, _gsap.gsap).timeline({
                paused: true
            });
            ...
            let stickyMap = (0, _gsap.gsap).timeline({
                paused: true
            });
        ...
        if ($('[data-barba-namespace="labsDetails"]').length) {
            let animationHeaderLabs = (0, _gsap.gsap).timeline({
                paused: true
            });
            mm.add("(min-width: 768px)", ()=>{
        ...
        if ($('[data-barba-namespace="projetsDetails"]').length && $('[data-barba-namespace="projetsDetails"] .project-details-intro .project-details-intro__cover .cover-image').length > 1) {
            let animationHeaderProjets = (0, _gsap.gsap).timeline({
                paused: true
            });
        ...
        if ($('[data-barba-namespace="thematiquesDetails"]').length) {
            ...
            (0, _gsap.gsap).utils.toArray("[data-barba-namespace]:last-child .paginated-section").forEach((section, i)=>{
                this.trigger.push((0, _scrollTrigger.ScrollTrigger).create({
                    trigger: section,
                    start: "top center",
                    end: "bottom center",
    ...
    this.scrollSection = function() {
        function goToSection(i, anim) {
            const elm = (0, _gsap.gsap).utils.toArray("[data-barba-namespace]:last-child .container");
            console.log(i, elm[i]);
            window.globalScroll.smooth.scrollTo(elm[i], {
                lock: true
            });
        }
        (0, _gsap.gsap).utils.toArray("[data-barba-namespace]:last-child .container").forEach((panel, i)=>{
            this.trigger.push((0, _scrollTrigger.ScrollTrigger).create({
                trigger: panel,
    ...
    this.lazyload = function() {
        (0, _gsap.gsap).utils.toArray("[data-barba-namespace]:last-of-type .container").forEach((section, i)=>{
    ...
    this.update = function() {
        (0, _scrollTrigger.ScrollTrigger).refresh(false);
    };
};

},{"gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","gsap/ScrollToPlugin":"9xJDW"}],"7wnFk":[function(require,module,exports) {
/*!
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lNOKz"], null, "parcelRequiree21d")

//# sourceMappingURL=scrollAnimation.7c2268dd.js.map
