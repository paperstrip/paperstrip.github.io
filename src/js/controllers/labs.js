...
window.labs = new (function () {
  this.index = function () {


  }
  this.details = function () {
    const drawingSlideShow = document.querySelector('[data-barba-namespace]:last-child .lab-drawing__slideshow')
    if (drawingSlideShow) {
      ...
      if (pagination) {
        ...
        customPagination = {
          el: '[data-barba-namespace]:last-child .lab-drawing__slideshow .swiper-pagination',
          clickable: true,
