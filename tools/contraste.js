...
const PAGES=['','consultance/','articles/','articles/combien-coute-une-automatisation-ia/','articles/pourquoi-une-automatisation-plante-en-production/','agents-metier/','pilotage-donnees/','sites-web-ia/','saas-sur-mesure/','sous-traitance/','ia-maitrisee/','a-propos/','contact/','mentions-legales/'];
