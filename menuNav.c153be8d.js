...
})({"kiaRs":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "47b66523c153be8d";
"use strict";
...
},{}],"kdoWv":[function(require,module,exports) {
...
window.menuNav = new function() {
    this.init = function() {
        ...
        $(document).on("click", function(event) {
            if ($(".main-header").hasClass("open") && $(event.target).closest(".main-header").length === 0) window.menuNav.hide();
        });
        ...
        $(".btn-menu").on("click", function(e) {
            e.preventDefault();
            if ($(this).hasClass("open")) window.menuNav.hide();
            else {
                window.menuNav.show();
    ...
    this.menuResizeHandler = function() {
        ...
        (0, _gsap.gsap).set($(".main-nav-center"), {
            clearProps: "all"
        });
        (0, _gsap.gsap).set($(".menu-item a"), {
            clearProps: "all"
        });
    //this.hide();
    };
    ...
    this.reset = function() {
        $(".main-header,.btn-menu").removeClass("open");
        (0, _gsap.gsap).set(".nav-wrapper", {
            backgroundColor: "rgba(0,0,0,0)"
        });
        (0, _gsap.gsap).to(".nav-footer", {
            autoAlpha: 0
        });
        (0, _gsap.gsap).set("header .menu-item a,header .social-list a .wrapper", {
            yPercent: 110
        });
        (0, _gsap.gsap).set(".main-nav-wrapper", {
            xPercent: -100
        });
    };
    this.updateCurrentLink = function() {
        ...
        $("header nav a").each(function(index) {
            ...
            if (elHref == document.location.href) $(this).addClass("current");
        });
    };
    this.initView = function() {
        ...
        if (container.getAttribute("data-page-title") === null) appendPageTitle.setAttribute("data-title", "");
        else appendPageTitle.setAttribute("data-title", container.getAttribute("data-page-title"));
...
},{"gsap":"fPSuC"}]},["kiaRs"], null, "parcelRequiree21d")

//# sourceMappingURL=menuNav.c153be8d.js.map
